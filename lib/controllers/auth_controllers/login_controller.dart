...
import 'package:fuel_feet/Api%20Services/api_helper_methods.dart';
import 'package:fuel_feet/Api%20Services/api_services.dart';
    ...
    try {
      ...
      Get.back();
        ...
        var otp = response['otp'];
           if(!resend){
             Get.to(() => VerifyOtpScreen(mobileNumber: verifyMobileController.text,otp:otp));
           }
           return true;
        }
